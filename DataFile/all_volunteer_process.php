<?php
	...
	$query = "SELECT * FROM `donor` WHERE (`name` LIKE '{$search_text}%' OR `donor_id` LIKE '%{$search_text}%' OR `blood_group` LIKE '{$search_text}%' OR `dept` LIKE '{$search_text}%' OR `hall` LIKE '{$search_text}%') AND `role`='volunteer' ";  
