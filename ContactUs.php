...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/indexcontactus.css">
    <script>
...
<body>
    ...
    <div class="content">
        <iframe name="container" src="DataFile/contactus.php" width="100%" height="100%" scrolling="auto" style="border:none;"></iframe> 
    </div>
    <div class="footer">
       <br>
        <p>
