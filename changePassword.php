...
<body>
            ...
            <ul>
                ...
                ?>
                 ...
                 <li> <a> <i class="glyphicon glyphicon-transfer"></i> Setings  </a>
                            <ul>
                                <li> <a href="changePassword.php"> <i class="glyphicon glyphicon-home"></i> Change Password </a> </li>
    ...
    <div class="contentt">
       <iframe name="container" src="DataFile/change_password.php" width="100%" height="100%" scrolling="auto"></iframe> 
    </div>
