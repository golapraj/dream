...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <div class="content">
        ...
        <iframe name="container" src="DataFile/dream_com.php" width="100%" height="100%" scrolling="auto" style="border:none;"></iframe> 
...
<div class="right_side">
                    ...
                    <marquee scrollamount="2" direction="up"  onmouseover="this.stop();" onmouseout="this.start();">
                      <div class="tab-content">
                        ...
                        <h5></h5>
                                ...
                                <?php
                                       $sql = "SELECT * FROM `noticefile` ORDER BY `noticefile`.`entry_date` DESC";  
                                       ...
                                       while ($row=mysql_fetch_array($result))
                                       {
                                        ...
                                        <a href="<?php echo $row['link']."\""; ?>" target="_blank"><?php echo $row['tittle']; ?><br>
        ...
        <div class="right_dwn">
            <a href="#"><img width="281px" src="images/donatebg.png"></a>
